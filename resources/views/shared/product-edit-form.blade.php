        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form class="max-w-md mx-auto" action="{{route('products.store')}}" method="POST">
                        @csrf
                        {{-- Nombre del producto --}}
                        ...
                        {{-- SKU --}}
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="sku" id="sku" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-600 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        @foreach ($warehouses as $warehouse)
                            <div class="relative z-0 w-full mb-5 group">
                                ...
                                <input type="number" name="warehouses[{{$warehouse->id}}][quantityAvailable]" id="warehouse[{{$warehouse->id}}]" min="0" oninput="validity.valid||(value='');" value="0" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-600 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
